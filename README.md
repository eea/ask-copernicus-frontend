[![Release](https://img.shields.io/github/v/release/eea/ask-copernicus-frontend?sort=semver)](https://github.com/eea/ask-copernicus-frontend/releases)
[![Pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto/ask-copernicus-frontend/master&subject=master)](https://ci.eionet.europa.eu/view/Github/job/volto/job/ask-copernicus-frontend/job/master/display/redirect)
[![Pipeline develop](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Fask-copernicus-frontend%2Fdevelop&subject=develop)](https://ci.eionet.europa.eu/view/Github/job/volto/job/ask-copernicus-frontend/job/develop/lastBuild/display/redirect)
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Fask-copernicus-frontend%2F3.408.0&build=last&subject=release%20v3.408.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/ask-copernicus-frontend/job/3.408.0/lastBuild/display/redirect/)

## [CLMS Installation](https://github.com/eea/ask-copernicus-frontend/blob/develop/CLMS_INSTALL.md) full guide
...
```bash
$ git clone git@github.com:eea/ask-copernicus-frontend.git
```
